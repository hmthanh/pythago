  ...
  try {
    {
      ...
      WString output_file = output_directory + L"watermark.bmp.pdf";
    ...
    }
    {
      ...
      WString output_file = output_directory + L"image_samples.jpg.pdf";
      Image2PDF(input_file,output_file);
    ...
    }
    {
      ...
      WString output_file = output_directory + L"TIF2Pages.tif.pdf";
      Image2PDF(input_file,output_file);
    ...
    }
    {
      ...
      WString output_file = output_directory + L"image005.gif.pdf";
      Image2PDF(input_file,output_file);
